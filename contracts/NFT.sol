...
pragma solidity ^0.8.1; // declare the version of solidity to compile this contract. This must match the version of solidity in your hardhat.config.js file
...
*/
    constructor() ERC721("MSTCNFT", "MSTCX") {}
